...
public class UserMealsUtil {
    public static void main(String[] args) {
        ...
        getFilteredWithExceeded(mealList, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000).forEach(m -> System.out.println(m));
    ...
    public static List<UserMealWithExceed> getFilteredWithExceededbyCircle(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        for (UserMeal uM : mealList) {
            ...
            if (TimeUtil.isBetween(lt, startTime, endTime)) {
                ...
                result.add(new UserMealWithExceed(uM.getDateTime(), uM.getDescription(), uM.getCalories(), map.get(ld) > caloriesPerDay));
